...
/**
 * ArgsParser is an implementation of a command-line argument parser in Scala.
 *
 * Original code based on jf.zarama's parse-cmd AScalaParserClass class
 * 
 ...
 *
 *   @see <a href="http://code.google.com/p/parse-cmd/wiki/AScalaParserClass">parse-cmd</a> project on googlecode
 */
class ArgsParser(val help: String) {
...
object Main {
  ...
  def main(args: Array[String]) = {
    ...
    val pp = new ArgsParser(helpString)
